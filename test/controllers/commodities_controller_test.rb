...
class CommoditiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commodity" do
    assert_difference('Commodity.count') do
      post commodities_url, params: { commodity: { Clothing: @commodity.Clothing, Mugs: @commodity.Mugs, Pouches: @commodity.Pouches } }
    end
  ...
  test "should update commodity" do
    patch commodity_url(@commodity), params: { commodity: { Clothing: @commodity.Clothing, Mugs: @commodity.Mugs, Pouches: @commodity.Pouches } }
